...
Method: 1) 提出六层能力导向分类法，从基本感知到高阶辨别对演示功能进行分类；2) 构建UniICL-760K大规模语料库，包含15个子任务的8-shot上下文学习片段；3) 设计上下文自适应原型调制器，作为轻量级即插即用模块稳定少样本适应。

Result: 在UniICL-Bench上的评估显示，该方法在大多数理解型上下文学习任务上优于更大参数的多模态大语言模型基线，取得了高度竞争力的统一结果。

Conclusion: 通过认知框架诊断上下文学习敏感性，结合大规模数据集和轻量级架构干预，能够有效提升多模态统一模型中上下文学习的稳定性和性能。
